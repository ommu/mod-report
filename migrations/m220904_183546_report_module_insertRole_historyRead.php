<?php
/**
 * m220904_183546_report_module_insertRole_historyRead
 * 
...
class m220904_183546_report_module_insertRole_historyRead extends \yii\db\Migration
{
	/**
	...
	public function up()
	{
		...
		if (Yii::$app->db->getTableSchema($tableName, true)) {
			$this->batchInsert($tableName, ['parent', 'child'], [
				['reportModLevelModerator', '/report/history/read/*'],
			]);
		}
	}
}
