...
// 	['label' => Yii::t('app', 'Add Report User'), 'url' => Url::to(['create']), 'icon' => 'plus-square'],
// ];
			...
			array_push($columnData, [
				...
				'buttons' => [
					'view' => function ($url, $model, $key) {
						...
						return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, ['title' => Yii::t('app', 'View Report User')]);
					},
