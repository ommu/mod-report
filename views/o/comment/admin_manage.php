	...
	<div class="boxed">
		...
		<?php 
			...
			array_push($columnData, array(
				...
				'buttons' => array(
					'view' => array(
						'label' => Yii::t('phrase', 'Detail Comment'),
					...
					'update' => array(
						'label' => Yii::t('phrase', 'Update Comment'),
						'imageUrl' => Yii::app()->params['grid-view']['buttonImageUrl'],
						'options' => array(
							'class' => 'update',
						),
					...
					'delete' => array(
						'label' => Yii::t('phrase', 'Delete Comment'),
						'imageUrl' => Yii::app()->params['grid-view']['buttonImageUrl'],
						'options' => array(
							'class' => 'delete',
						),
