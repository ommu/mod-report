...
<div class="dialog-content">
	<fieldset>
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model, 'report_id', array('class'=>'col-form-label col-lg-4 col-md-4 col-sm-12')); ?>
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model, 'user_id', array('class'=>'col-form-label col-lg-4 col-md-4 col-sm-12')); ?>
			<div class="col-lg-8 col-md-8 col-sm-12">
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model, 'comment_text', array('class'=>'col-form-label col-lg-4 col-md-4 col-sm-12')); ?>
			<div class="col-lg-8 col-md-8 col-sm-12">
