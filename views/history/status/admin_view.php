...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Delete'), 'url' => Url::to(['delete', 'id'=>$model->history_id]), 'htmlOptions' => ['data-confirm'=>Yii::t('app', 'Are you sure you want to delete this item?'), 'data-method'=>'post', 'class'=>'btn btn-danger btn-sm'], 'icon' => 'trash'],
];
?>
...
<?php echo DetailView::widget([
	...
	'attributes' => [
		...
		[
			'attribute' => 'status',
			'value' => $model->filterYesNo($model->status),
		],
		[
