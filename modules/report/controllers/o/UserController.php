...
class UserController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = ReportUser::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('ReportUser', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Report Users');
	...
	public function actionView($id) 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'View Report Users');
	...
	public function actionManage() 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'Report Users Manage');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['ReportUser'])) {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'ReportUser success created.').'</strong></div>',
						));
					} else {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'ReportUser success created.'));
		...
		$this->pageTitle = Yii::t('phrase', 'Create Report Users');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['ReportUser'])) {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'get' => Yii::app()->controller->createUrl('manage'),
							'id' => 'partial-report-user',
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'ReportUser success updated.').'</strong></div>',
						));
					} else {
						print_r($model->getErrors());
					}
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'ReportUser success updated.'));
					//$this->redirect(array('view','id'=>$model->id));
					$this->redirect(array('manage'));
				}
			}
		...
		$this->pageTitle = Yii::t('phrase', 'Update Report Users');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionDelete($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			if(isset($id)) {
				if($model->delete()) {
					echo CJSON::encode(array(
						...
						'get' => Yii::app()->controller->createUrl('manage'),
						'id' => 'partial-report-user',
						'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'ReportUser success deleted.').'</strong></div>',
					));
				}
			}
			...
			$this->pageTitle = Yii::t('phrase', 'ReportUser Delete.');
			$this->pageDescription = '';
			$this->pageMeta = '';
