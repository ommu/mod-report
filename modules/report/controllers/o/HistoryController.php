				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'Report Histories success created.').'</strong></div>',
						));
					} else {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'get' => Yii::app()->controller->createUrl('manage'),
							'id' => 'partial-report-history',
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'Report Histories success updated.').'</strong></div>',
						));
					} else {
						print_r($model->getErrors());
					}
